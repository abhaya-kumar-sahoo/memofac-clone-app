...
export default class NotificationService {
  constructor(onRegister, onNotification) {
    ...
    PushNotification.getChannels(function (channels) {
      // console.log(`\n\n\nCHANNELS IN THIS APPLICATION${channels}====>\n\n\n`);
    });
  }
  ...
  createDefaultChannels() {
    PushNotification.createChannel(
      {
        channelId: 'memofac_channel_001', // (required)
      ...
      created =>
        console.log(
          `createChannel 'memofac_channel_001' returned '${created}'`,
  ...
  createOrUpdateChannel() {
    ...
    PushNotification.createChannel(
      {
        channelId: 'memofac_channel_001', // (required)
        channelName: `memofac_channel_001 - Counter: ${this.lastChannelCounter}`, // (required)
  ...
  localNotificationMethod(soundName) {
    this.lastId++;
    PushNotification.localNotification({
      /* Android Only Properties */
      channelId: 'memofac_channel_001',
      ...
      color: '#4A6872', // (optional) default: system default
